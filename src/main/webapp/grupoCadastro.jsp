            ...
            <div class="container nav-justified">
                ...
                <ul class="nav nav-tabs navbar-static-top" id="menuNav">
                    ...
                    <li><a data-toggle="tab" href="#generos">Gêneros</a></li>
                        ...
                        <li  class="active"><a data-toggle="tab" href="#criarGrupos">Criar Grupo</a></li>
                        </c:if>
                ...
                <div class="tab-content">
                    ...
                    <c:if test="${sessionScope.user.tipo == true}">
                        ...
                        <div id="criarGrupos" class="tab-pane text-center fade in active">
                            <br>
                            <div>
                                <h3>Crie um grupo</h3>
                                <p>Erro ao criar grupo.</p>
                                <div class="form-group">
