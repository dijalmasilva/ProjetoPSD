                        ...
                        <div class="text-center margin-top table-responsive modal-header modal-dialog">
                            ...
                            <div class="table-overflow-comentarios">
                                ...
                                <c:forEach items="${avaliacoes}" var="a">
                                    <div class="text-left">
                                        <img src="${user.foto}" alt="${user.apelido}" title="${user.apelido}" class="img-perfil">
                                        <a href="ControlePerfilVisitante?idDoUsuario=${user.id}" class="text-capitalize active">${user.apelido}: </a><label>Comentarios</label><br>
                                    </div>
                                </c:forEach>
                            </div>
                        </div>
